...
The main aim for this undertake is to be able to create various pieces (.gcode) with different settings (infill, infill-methods, temperature etc) and <b>then,/b> concate them for <b>one</b> print (untested).
